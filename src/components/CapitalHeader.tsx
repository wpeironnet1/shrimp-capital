  ...
  return <View style={styles.shell}>
    <View style={[styles.topRow,mobile&&styles.topRowMobile]}>
      ...
      <View style={[styles.cashBox,mobile&&styles.cashBoxMobile,tiny&&styles.cashBoxTiny]} accessible accessibilityLabel={`Liquid capital ${cash.toLocaleString()} dollars`}>
        ...
        <View style={styles.cashRow}><View style={styles.coin}><PixelText style={styles.coinText}>$</PixelText></View><PixelText numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.82} style={[styles.cash,mobile&&styles.cashMobile]}>${cash.toLocaleString()}</PixelText></View>
      </View>
    </View>
...
const styles=StyleSheet.create({
  ...
  cashBox:{minWidth:178,backgroundColor:'#061820',borderWidth:2,borderColor:colors.brass,padding:10,alignItems:'flex-end'},cashBoxMobile:{width:'100%',minWidth:0,flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:11,paddingVertical:10,gap:10},cashBoxTiny:{paddingVertical:9},
  cashLabel:{fontSize:13,color:colors.muted,letterSpacing:.35,flexShrink:1},cashRow:{flexDirection:'row',alignItems:'center',justifyContent:'flex-end',gap:7,flexShrink:1,minWidth:0},coin:{width:24,height:24,borderRadius:12,backgroundColor:colors.gold,borderWidth:2,borderColor:colors.goldLight,alignItems:'center',justifyContent:'center',flexShrink:0},coinText:{fontSize:13,color:colors.brassDark},cash:{fontFamily:'PressStart2P',fontSize:12,color:colors.goldLight,flexShrink:1},cashMobile:{fontSize:12},
  ...
  plaqueCenter:{minWidth:320,backgroundColor:'#0A151A',borderWidth:2,borderColor:colors.brass,padding:3},plaqueCenterMobile:{minWidth:0,width:'88%',maxWidth:420},plaqueCenterTiny:{width:'100%',marginHorizontal:8},
