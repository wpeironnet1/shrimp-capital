...
const styles = StyleSheet.create({
  ...
  heading: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, kicker: { color: colors.aqua, fontSize: 8, letterSpacing: 1.5 }, title: { fontSize: 13, marginTop: 4 }, rewards: { alignItems: 'flex-end' }, reward: { color: colors.gold, fontSize: 13 }, rewardXp: { color: colors.aqua, fontSize: 8, marginTop: 3 },
