...
const styles=StyleSheet.create({
  ...
  headerBand:{backgroundColor:'#0A2731',borderBottomWidth:2,borderBottomColor:colors.brass,paddingHorizontal:12,paddingVertical:10,flexDirection:'row',justifyContent:'space-between',alignItems:'center',gap:10},headerBandMobile:{paddingHorizontal:11,paddingVertical:10},headerBandTiny:{flexDirection:'column',alignItems:'stretch',gap:8},headerCopy:{flex:1,minWidth:0},
  card:{backgroundColor:'#123844',padding:14,borderWidth:1,borderColor:'#315E67'},cardTiny:{padding:12},kicker:{color:colors.aqua,fontSize:13,letterSpacing:.25},mandateNumber:{color:'#AFC6CA',fontSize:13,marginTop:2},title:{fontFamily:'PressStart2P',fontSize:12,lineHeight:20,color:colors.cream},titleMobile:{fontSize:12,lineHeight:20},rewards:{alignItems:'flex-end'},rewardsMobile:{minWidth:96},rewardsTiny:{minWidth:0,width:'100%',flexDirection:'row',alignItems:'center',justifyContent:'space-between',backgroundColor:'#071D25',borderWidth:1,borderColor:'#315E67',paddingHorizontal:10,paddingVertical:7},reward:{color:colors.goldLight,fontSize:16},rewardXp:{color:colors.aqua,fontSize:13,marginTop:2},detail:{color:'#D0DEE0',fontSize:15,marginTop:9,lineHeight:21},progressRow:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',gap:8,marginTop:13},progressRowTiny:{marginTop:14},progressLabel:{fontSize:13,color:colors.muted},progressText:{fontSize:14,color:colors.cream},percentRow:{alignItems:'flex-end',marginTop:3},percentRowTiny:{alignItems:'flex-start'},percentText:{fontSize:13,color:colors.aqua},
  ...
  claim:{marginTop:13,backgroundColor:colors.gold,borderWidth:2,borderColor:colors.goldLight,borderBottomWidth:5,borderBottomColor:colors.brassDark,paddingVertical:13,minHeight:54,alignItems:'center',justifyContent:'center'},claimTiny:{minHeight:58},claimPressed:{transform:[{translateY:3}],borderBottomWidth:2},claimText:{fontFamily:'PressStart2P',color:colors.ink,fontSize:12},
